...
oracion = set(raw_input(">>> Proporcione una oracion ").split())
...
if ( r1 > r2):
	if (r1 > r3):
		print "la oracion pertenece al conjunto animal"
	else:
		print "la oracion pertenece al conjunto juego"
elif (r2 > r3):
	print "la oracion pertenece al conjunto hidraulico"
else:
	print "la oracion pertenece al conjunto juego"
